            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 ">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link" href="http://localhost/metakMVC/admin/posts">POSTLAR</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="http://localhost/metakMVC/admin/addpost">Yeni əlavə et</a>
                        </li>
                ...
                <div class="col-lg-10 mt-5">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <input type="text" class="form-control" name="name" placeholder="POST BAŞLIĞI...">
                        </div>
                        <div class="form-group">
                            <textarea class="form-control" name="text" name="text" rows="5" placeholder="POST TEXTİ..."></textarea>
                        </div>
